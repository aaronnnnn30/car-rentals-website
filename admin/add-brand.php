...
<div id="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="formBrand" method="post" action="./src/brand.php" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="form-group col-lg-">
                            <label for="name">Brand Name</label>
                            <input type="text" id="name" class="form-control" name="name" placeholder="Enter brand name">
                            <small id="nameError" class="form-text text-danger"></small>
                        </div>
                        <div class="form-group col-lg-6">
                            <label for="name">Image</label>
                            <input type="file" id="image" class="form-control" name="photo" placeholder="Enter class name">
