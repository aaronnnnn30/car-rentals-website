...
<div id="content-wrapper">
                ...
                <form id="formCar" method="post" action="" enctype="multipart/form-data">
                    <div class="form-row">
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" id="car_name" class="form-control" name="car_name" placeholder="Enter car name">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" id="car_body_type" class="form-control" name="car_body_type" placeholder="Enter car body type ">
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" id="transmission" class="form-control" name="transmission" placeholder="Enter transmission">
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-3">
                            ...
                            <input type="text" id="seating_capacity" class="form-control" name="seating_capacity" placeholder="Enter seating capacity ">
                            <small id="seatingCapacityError" class="form-text text-danger"></small>
                        </div>
                        <div class="form-group col-lg-3">
                            <label for="name">Km Driven</label>
                            <input type="text" id="km_driven" class="form-control" name="km_driven" placeholder="Enter KM driven ">
                            <small id="kmDrivenError" class="form-text text-danger"></small>
                        </div>
                        <div class="form-group col-lg-3">
                            <label for="name">Price Per Day</label>
                            <input type="text" id="price_per_day" class="form-control" name="price_per_day" placeholder="Enter price per day">
                            <small id="pricePerDayError" class="form-text text-danger"></small>
                        </div>
                        <div class="form-group col-lg-3">
                            <label for="name">Registration No</label>
                            <input type="text" id="reg_no" class="form-control" name="reg_no" placeholder="Enter reg no">
                    ...
                    <div class="form-row">
                        <div class="form-group col-lg-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="ac" id="flexRadioDefault1" value="1">
                                <label class="form-check-label" for="flexRadioDefault1">
                                    Yes
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="ac" id="flexRadioDefault2" value="0" checked>
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="sun_roof" id="flexRadioDefault1" value="1">
                                <label class="form-check-label" for="flexRadioDefault1">
                                    Yes
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="sun_roof" id="flexRadioDefault2" value="0" checked>
                                <label class="form-check-label" for="flexRadioDefault2">
                                    No
                                </label>
                            </div>
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="air_bags" id="flexRadioDefault1" value="1">
                                <label class="form-check-label" for="flexRadioDefault1">
                                    Yes
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="air_bags" id="flexRadioDefault2" value="0" checked>
                                <label class="form-check-label" for="flexRadioDefault2">
                                    No
                                </label>
                            </div>
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="central_lock" id="flexRadioDefault1" value="1">
                                <label class="form-check-label" for="flexRadioDefault1">
                                    Yes
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="central_lock" id="flexRadioDefault2" value="0" checked>
                                <label class="form-check-label" for="flexRadioDefault2">
                                    No
                                </label>
                            </div>
    ...
    <script>
        ...
        const pricePerDayError = document.querySelector('#pricePerDayError');
        ...
        function displayErrors(error) {
            ...
            pricePerDayError.innerHTML = error.price_per_day;
